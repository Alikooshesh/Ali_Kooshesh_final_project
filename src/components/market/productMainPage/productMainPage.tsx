            ...
            <div className={"w-full mt-3 px-0 lg:px-28"}>
                ...
                <section className={"w-full relative mt-3 md:flex"}>
                    <div className={"w-full lg:w-8/12 2xl:w-9/12 rounded-lg border-1 border-transparent bg-transparent"}>
                        ...
                        <div id={"info"} className={"w-full font-anjoman pt-2 px-5 rounded-lg border-1 border-transparent bg-gray-100 mt-2"}><ProductInfoBox property={productData && productData.fullProperty}/></div>
                        <div id={"comments"} className={"w-full font-anjoman pt-2 px-5 rounded-lg border-1 border-transparent bg-gray-100 mt-2"}><ProductCommentBox commentList={productData && productData.comment}/></div>
                    </div>

                    <div className={"sticky top-0 left-0 h-96 hidden lg:block w-4/12 2xl:w-3/12 rounded-lg border-2 border-gray-300 bg-gray-100 px-5 py-3 mr-2"}>
                        <div className={"w-3/5 h-2/3 bg-gray-100 rounded-lg mx-auto"}>
                            <img className={"w-full h-full"} src={`${productData && productData.img[0]}`} alt={productData?.productName} loading={"lazy"}/>
                        </div>
                        <p className={"font-anjoman text-gray-700 text-center mt-2"}>کارت گرافیک ام اس آی RTX 2060 GAMING 6G</p>
