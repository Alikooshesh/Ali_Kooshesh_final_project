...
function LoginPage() {
    ...
    return(
        <div className={"w-full h-full flex justify-center items-center bg-gray-300"}>
            <div className={`${box != 1 && 'hidden'} w-1/4 bg-gray-200 rounded-lg px-3 py-2 text-center font-anjoman text-gray-600`}>
            ...
            <div className={`${box != 2 && 'hidden'} w-1/4 bg-gray-200 rounded-lg px-3 py-2 text-center font-anjoman text-gray-600`}>
